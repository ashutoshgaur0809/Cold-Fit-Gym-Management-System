        ...
        <div class="col-12 col-md-6 col-xl-7">
          <div class="d-flex justify-content-center text-bg-dark">
            <div class="col-12 col-xl-9">
              ...
              <a href="main/AdminRegistraion"><i class="fa-solid fa-arrow-left-long"></i></a>
            </div>
          </div>
        </div>
        <div class="col-12 col-md-6 col-xl-5">
          <div class="card border-0 rounded-4">
            <div class="card-body p-3 p-md-4 p-xl-5">
              ...
              <form action="Main/CheckAdmin" name="insertAdmin" method="post">
              ...
              <div class="row">
                <div class="col-12">
                  <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end mt-4">
                    <p class="m-0 text-secondary text-center">Not having account go with Admin Registration <a href="main/AdminRegistraion.cfm" class="link-dark text-decoration-none">Admin Registraion</a></p>
                  </div>
                </div>
              </div>
