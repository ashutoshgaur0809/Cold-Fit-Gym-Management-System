        ...
        <div class="col-12 col-md-6 col-xl-7">
          <div class="d-flex justify-content-center text-bg-dark">
            <div class="col-12 col-xl-9">
              ...
              <a href="main/index"><i class="fa-solid fa-arrow-left-long"></i></a>
            </div>
          </div>
        </div>
        <div class="col-12 col-md-6 col-xl-5">
          <div class="card border-0 rounded-4">
            <div class="card-body p-3 p-md-4 p-xl-5">
              ...
              <form action="Main/CheckUser" name="getUser" method="POST">
              ...
              <div class="row">
                <div class="col-12">
                  <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end mt-4">
                    <p class="m-0 text-secondary text-center">Not Having Account? <a href="main/index" class="link-dark text-decoration-none">Register</a></p>
                  </div>
                </div>
              </div>
              <div class="row">
