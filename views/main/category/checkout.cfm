                ...
                <div class="row g-5">
                    ...
                    <div class="col-md-7 col-lg-8">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button class="btn btn-primary btn-custom" type="submit"><a href="main.category/FinalCheckout/?btnid=#btnid#" class="text-light text-decoration-none">Continue to checkout</a></button>
                        </div>
                    </div>
                </div>
            </form>
